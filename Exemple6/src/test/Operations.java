...
public class Operations {
	...
	public static void clientBuyProcess() {
		...
		while (true) {
			...
			if ( userType.equals("vip") || userType.equals("regular") || userType.equals("new")) {
				...
				calculetTicket (discount, totalDiscount, amountToPay, userBuy);
				/*
	...
	private static void calculetTicket(int discount, int totalDiscount, int amountToPay, int userBuy ) {
		double tax = 0.21;
